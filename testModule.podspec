...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/forestfsl/testModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'forestfsl' => 'fengsonglin@139.com' }
  s.source           = { :git => 'https://github.com/forestfsl/testModule.git', :tag => s.version.to_s }
